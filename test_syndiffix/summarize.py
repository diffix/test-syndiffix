...
def summarize(measuresDir='measuresAb',
    ...
    doPlots(tu, dfAll, ['syndiffix', 'ctGan', 'mostly', 'synthpop'], force=force)
    ...
    doPlots(tu, dfAll, ['synthpop', 'synthpop100'], force=force)
    doPlots(tu, dfAll, ['synthpop', 'synthpop1000'], force=force)
    for synMethod in synMethods:
        if synMethod == 'syndiffix':
            continue
        doPlots(tu, dfAll, ['syndiffix', synMethod], force=force)
